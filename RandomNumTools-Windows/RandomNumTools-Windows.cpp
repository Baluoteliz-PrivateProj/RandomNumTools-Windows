...
// RandomNumTools-Windows.cpp : Defines the class behaviors for the application.
//
...
// CRandomNumToolsWindowsApp

BEGIN_MESSAGE_MAP(CRandomNumToolsWindowsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CRandomNumToolsWindowsApp construction

CRandomNumToolsWindowsApp::CRandomNumToolsWindowsApp()
{
...
BOOL CRandomNumToolsWindowsApp::InitInstance()
{
